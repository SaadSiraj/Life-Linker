...
class _ReusableTextFieldState extends State<ReusableTextField> {
    ...
    return Padding(
      ...
      child: Icon(
        ...
        color:
            ...
            (_isFocused ? AppColors.primary : colorScheme.onSurfaceVariant),
        size: 22,
      ),
    );
  }
    ...
    if (_shouldShowPasswordToggle) {
      return IconButton(
        icon: Icon(
          ...
          color: _isFocused ? AppColors.primary : colorScheme.onSurfaceVariant,
          size: 22,
        ),
  ...
  Widget build(BuildContext context) {
    ...
    // Label and hint use onSurface (white in dark theme) so they stay visible
    ...
    return Column(
      ...
      children: [
        // Label above the field (white in dark theme)
        ...
        AnimatedContainer(
          ...
          child: TextFormField(
            ...
            decoration: InputDecoration(
              ...
              counterStyle: widget.maxLength != null
                  ? TextStyle(color: hintColor, fontSize: 11)
                  : null,
              filled: true,
